...
<section class="h-100 h-custom gradient-custom-2">
    <div class="container py-5">
        <div class="row d-flex justify-content-center align-items-center">
            <div class="col-12">
                <form id="signup" action="Function/daftar_mitra" method="POST">
                                    ...
                                    <div class="p-5">
                                        ...
                                        <div class="mb-2 pb-2">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="2" id="role" name="role">
                                                <label class="form-check-label" for="mitraCheckbox">Dengan mencentang ini anda setuju untuk bergabung menjadi mitra kami</label>
                                            </div>
                                        </div>
                                        <!-- <div class="mb-2 pb-2">
                                            <div class="form-outline">
