    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="produk_mitra">Plan</a></li>
                ...
                <div class="row">
                    <div class="col-md-6 col-xs-12">
                        <div class="boxprofile p-5">
                            ...
                            <h3 style="font-size: 25px;"><b><?= $dataUser->nama ?></b></h3>
                            <h4 style="color: #F4F9F9;"><?= $dataUser->nama_usaha ?></h4>
                            <p class="my-2" style="color: #898989;">Lokasi : <?= $dataUser->lokasi ?></p>
                    ...
                    <div class="col-md-6 col-xs-12">
                        <div class="boxprofile" style="width: 100%;">
                            ...
                            <a href="akun_mitra " class="btnpu" style="display: flex; align-items: center; margin-bottom: 10px;">
