    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
          <ul>
              ...
              if ($status_pesanan == 1) {
                  echo '<li><a href="menu" class="notification  active"><span class="notification-dot"></span>Menu</a></li>';
              } else {
                ...
                <div class="pengingatbox">
                  <div class="portfolio-wrap">
                    ...
                    <div class="portfolio-info">
                      ...
                      <p style="text-align: left;">Mitra : <?php echo $food->nama_mitra?></p>
                      <a href="Function/tambahpesanan?id=<?php echo $food->_id ?>&nama_produk=<?php echo $food->nama_produk ?>" class="btnbox"><img src="assets/img/icon/vektorKeranjang.svg" alt="">Pesan</a>
                    </div>
                  </div>
                </div>
              </div>
